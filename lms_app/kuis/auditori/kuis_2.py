...
def kuis_auditori_2():
    st.subheader("📋 Kuis auditori: Fungsi Organ Sistem Pencernaan")
    skor = 0
    ...
    with st.form("kuis_auditori_form"):
    ...
    if submit:
        ...
        st.session_state.skor["Auditori"] += skor
        st.session_state.akses["Auditori"] += 1
